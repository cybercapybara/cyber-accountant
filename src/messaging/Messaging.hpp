...
public:
    void initialize(const std::string& broker_list, const std::string& client_id = "cyber_accountant_producer") {
        if (initialized) {
...
public:
    void initialize_producer(const std::string& brokers, const std::string& client_id = "cyber_accountant_producer") {
