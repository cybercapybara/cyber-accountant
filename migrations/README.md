...
- `./cyber_accountant --verify-migrations` — list pending files without
  applying (useful as a CI gate; exits 1 if any are pending).
- `./cyber_accountant --run-migrations` — apply pending migrations and exit
...
- `RUN_MIGRATIONS_ONLY=1 ./cyber_accountant` — env-var equivalent of
