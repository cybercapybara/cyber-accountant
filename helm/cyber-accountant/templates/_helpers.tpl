...
*/}}
{{- define "cyber-accountant.fullname" -}}
...
Common labels.
*/}}
{{- define "cyber-accountant.labels" -}}
helm.sh/chart: {{ include "cyber-accountant.chart" . }}
{{ include "cyber-accountant.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels.
*/}}
{{- define "cyber-accountant.selectorLabels" -}}
app.kubernetes.io/name: {{ include "cyber-accountant.name" . }}
...
*/}}
{{- define "cyber-accountant.databaseEnv" -}}
- name: DATABASE_HOST
