...
- The cyber-accountant chart gained the missing uploads-storage wiring
...
- **Helm**: guard the cyber-accountant `mail-smtp-password` Secret against a nil `mail`
...
### Added
- Public demo environment at `*.demo.example.com` — `helm/cpp-env/values-demo.yaml`
...
- **Security:** constant-time bearer-token compare; the production auth-guard is
  now actually armed (`APP_ENV` wired through config + Helm); the cyber-accountant chart
...
[Unreleased]: https://gitlab.com/example.com/cyber-accountant/-/compare/v1.2.0...master
[1.2.0]: https://gitlab.com/example.com/cyber-accountant/-/compare/v1.1.0...v1.2.0
[1.1.0]: https://gitlab.com/example.com/cyber-accountant/-/compare/v1.0.0...v1.1.0
